...
console.log(userData?.details?.contact?.email); // "jane@example.com"
console.log(userData.details.contact.email); // "jane@example.com"
...
console.log(customer.orders?.[1]); // Expected: undefined
...
function getInStockProductNames(products) {
  return products
...
console.log(getInStockProductNames(products)); // "LAPTOP"
